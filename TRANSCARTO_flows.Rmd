...
Sauvegarder du fichier (matrice carrée incluant les zero) mis en forme au format .csv
```{r, eval = TRUE, message = FALSE, warning = FALSE}
...
Réalisation d'une troisème carte mettant en relation la France avec les pays d'origine des étrangers qui résident sur le territoire national, et pondération de ces liens en fonction du nombre de personnes concernées.
