...
Ce jeu décrit l'effectif de populations partie ou acceuillie dans un pays autre que le leur, autorisant ainsi une géovisualisation sous la forme de stocks  et/ou sous la forme de flux de populations étrangères.
...
Pour simplifier la carte, on peut choisir un seul pays de référence depuis/vers lequel on observe les flux.
...
Création d'une sous-matrice migrFRA, jointure et mise en forme des données
...
Réalisation d'une première carte de stocks sur le nombre d'étrangers en France : ; elle correspond à la somme marginale de la colonne iso3=FRA.
